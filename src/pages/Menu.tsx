  ...
  coffee: [
    {
      ...
      price: "₹180",
      image: "/images/food/signature_latte.jpg",
      featured: true,
    },
    {
      name: "Velora Latte",
      ...
      price: "₹220",
      image: "/images/food/velora_latte.jpg",
      featured: true,
    },
    {
      name: "Flat White",
      ...
      price: "₹200",
      image: "/images/food/flat_white.jpg",
      featured: false,
    },
    {
      name: "Cappuccino",
      ...
      price: "₹190",
      image: "/images/food/capucina.jpg",
      featured: false,
    },
    {
      name: "Americano",
      ...
      price: "₹160",
      image: "/images/food/amricano.jpg",
      featured: false,
    },
    {
      name: "Mocha",
  ...
  pastries: [
    {
      ...
      price: "₹160",
      image: "/images/food/pastires1.jpg",
      featured: false,
    },
    {
      ...
      price: "₹260",
      image: "/images/food/artesian_pastries.jpg",
      featured: true,
    },
    {
      ...
      price: "₹220",
      image: "/images/food/pexels-soc-nang-d-ng-2150345854-34810078.jpg",
      featured: true,
    },
    {
      name: "Cinnamon Roll",
      ...
      price: "₹180",
      image: "/images/food/cinnamon.jpg",
      featured: false,
    },
    {
      ...
      price: "₹150",
      image: "/images/food/pastries2.jpg",
      featured: false,
    },
  ],
  drinks: [
    {
      ...
      price: "₹260",
      image: "/images/food/speciality_drinks.jpg",
      featured: true,
    },
    {
      ...
      price: "₹240",
      image: "/images/food/cold_brue.jpg",
      featured: false,
    },
    {
      ...
      price: "₹300",
      image: "/images/food/elegance.jpg",
      featured: true,
    },
    {
      ...
      price: "₹250",
      image: "/images/food/speciality_drink2.jpg",
      featured: false,
    },
  ],
  sandwiches: [
  ...
  desserts: [
    {
      ...
      price: "₹350",
      image: "/images/food/choco_lava.jpg",
      featured: true,
    },
    {
      name: "Tiramisu",
      ...
      price: "₹300",
      image: "/images/food/pexels-zeynep-merve-kilic-cakir-76946886-34889845.jpg",
      featured: true,
    },
    {
      ...
      price: "₹280",
      image: "/images/food/cheecake.jpg",
      featured: false,
    },
  ],
};
...
const Menu = () => {
  return (
    <main className="min-h-screen pt-20">
      {/* Hero Section */}
      <section className="py-24 md:py-32 gradient-sepia relative overflow-hidden border-b-2 border-burgundy/10">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-20 left-10 w-96 h-96 bg-burgundy rounded-full blur-3xl" />
          <div className="absolute bottom-20 right-10 w-72 h-72 bg-antique-gold rounded-full blur-3xl" />
        </div>
        <div className="container mx-auto px-6 relative">
          <div className="max-w-4xl mx-auto text-center">
            <p className="text-burgundy font-medium mb-4 tracking-wider uppercase text-sm animate-fade-in">
              Handcrafted Selection
            </p>
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-serif font-bold mb-8 animate-fade-in text-burgundy">Our Menu</h1>
            <div className="w-24 h-1 gradient-burgundy mx-auto mb-10 animate-fade-in" />
      ...
      <section className="py-24 md:py-32 bg-background">
        <div className="container mx-auto px-6">
          <div className="mb-16 text-center">
            <p className="text-burgundy font-medium mb-4 tracking-wider uppercase text-sm">Premium</p>
            <h2 className="text-4xl md:text-5xl font-serif font-bold mb-4 text-burgundy">Specialty Coffee</h2>
            <div className="w-20 h-1 gradient-burgundy mx-auto" />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10 max-w-7xl mx-auto">
            {menuItems.coffee.map((item, index) => (
              <Card
                key={index}
                className="overflow-hidden border-2 border-burgundy/15 hover:border-burgundy transition-vintage shadow-card hover:shadow-vintage group hover-lift-vintage"
              >
                <div className="relative h-72 overflow-hidden">
                  <img
                    ...
                    alt={item.name}
                    loading="lazy"
                    className="w-full h-full object-cover group-hover:scale-110 transition-vintage duration-700 sepia-filter"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-burgundy/30 to-transparent opacity-0 group-hover:opacity-100 transition-vintage" />
                </div>
